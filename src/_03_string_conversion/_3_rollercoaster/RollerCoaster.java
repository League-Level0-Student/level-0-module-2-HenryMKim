...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
	    ...
	    // "Hurray! You are tall enough to ride the coaster alone!" Hint: use JoptionPane
			if( heightAsInt >= 48 ) {JOptionPane.showMessageDialog(null, "You are tall enough to ride the roller coaster by yourself! ");}
			else if( heightAsInt >= 42) {JOptionPane.showMessageDialog(null, "You are tall enough to ride the roller coaster with someone else! "); }
		...
		// 6) else print: "You must be at least 42 inches tall to ride the roller coaster pal!"
			else if( heightAsInt < 42 ) {JOptionPane.showMessageDialog(null, "You must be at least 42 inches tall to ride the roller coaster pal! ");}

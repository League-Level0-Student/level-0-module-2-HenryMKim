...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			String fourAsString = JOptionPane.showInputDialog(null, "Enter the number 4 below!");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
			String sixAsString = JOptionPane.showInputDialog(null, "Enter the number 6 below!");
			// 4) Print the addition of fourAsString and sixAsString using JOptionPane 
			JOptionPane.showMessageDialog(null, "here is 4 + 6. "+ fourAsString + sixAsString);
			// Did you notice 46 instead of 4 + 6 = 10?
			//yea
			// 5) Ask the user to enter number 5 and hold it in the variable fiveAsString 
			String fiveAsString = JOptionPane.showInputDialog(null, "Enter the number 5 below!");
			// 6) Print the addition of the variables fourAsString, sixAsString, and fiveAsString 
			JOptionPane.showMessageDialog(null, "here is 4 + 6 + 5. "+ fourAsString + sixAsString + fiveAsString);
...
int fiveAsInt = Integer.parseInt(fiveAsString);
			...
			int LLL = fiveAsInt + ten;
			JOptionPane.showMessageDialog(null, "here is 4 + 6 + 5. "+ LLL);
